...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `user_form`(name, email, password, age, contact_number, address, image) VALUES('$name', '$email', '$pass', '$age', '$contact_number', '$address', '$image')") or die('Query failed');
